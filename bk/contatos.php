            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <p class="box-contacts-link"><a href="http://api.whatsapp.com/send?1=pt_BR&amp;phone=55949840600" target="_blank">(94)98404-9600</a></p>
            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="#">rua da torre, nº 321, centro</a></p>
                </div>
              </article>
            </div>
            <div class="col-sm-8 col-md-6 col-lg-4">
