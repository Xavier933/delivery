  ...
  <div class="container">
    <div class="row row-40 mb-3">
      ...
      <div class="col-md-12 col-lg-12">
          ...
          <?php if(@$_GET['categoria'] != ''){ 
            ...
            ?>
             ...
             <h5 class="titulo-produtos">Categoria <?php echo $nome_categoria ?></h5><span></span>
          ...
          <?php }else{
           ...
           ?>
         <h5 class="titulo-produtos">Produtos Mais Vendidos</h5><span><a title="Ver toda a lista de Produtos" href="lista-produtos.php" target="_blank">Ver Todos</a></span>
         <hr class="linhatitulo"> 
        <?php } ?>
                  ...
                  <div class="unit flex-row flex-lg-column">
                    <div class="unit-left">
                      ...
                      <form method="post">
                        ...
                        <div class="product-button"><a class="button button-md button-white button-ujarak" href="" onclick="carrinhoModal('<?php echo $id ?>')" class="button button-md button-white button-ujarak" id="btn-carrinho">Add ao Carrinho</a></div>
                      </form>
     ...
     <div class="row row-40 <?php echo @$dnone ?>">
      ...
      <div class="col-md-12 col-lg-12">
         <h5 class="titulo-produtos">Combos Mais Vendidos</h5><span><a title="Ver toda a lista de Combos e Promoções" href="combos.php" target="_blank">Ver Todos</a></span>
         <hr class="linhatitulo"> 
        <div class="row row-30">
    ...
    <!--PRODUTOS MAIS RECENTES -->
     <div class="row row-40 <?php echo @$dnone ?>">
      ...
      <div class="col-md-12 col-lg-12">
         <h5 class="titulo-produtos">Produtos Mais Recentes</h5>
         <hr class="linhatitulo"> 
        <div class="row row-30">
