...
<section class="section section-md bg-default">
    <div class="container">
        <h2 class="wow slideInUp" data-wow-delay="0s" style='text-align:center'>Categorias</h2>
                ...
                <div class="row row-30 ">
                        ...
                        <div class="col-sm-12 col-md-3 col-lg-3">
                            ...
                            <article class="product product-2 box-ordered-item wow slideInRight" data-wow-delay="0s">
                                ...
                                <div class="unit-body">
                                    <h6 class="product-title"><a href="#" title="<?php echo $descricao?>'"><?php echo $nome ?></a></h6>
