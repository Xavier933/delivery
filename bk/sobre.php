<?php include_once("cabecalho.php")?>
      ...
      <section class="section section-md section-first bg-default text-md-left">
        ...
        <div class="container">
          <div class="row row-50 justify-content-center">
            <div class="col-md-10 col-lg-5 col-xl-6"><img src="images/galeria/cozinha.jpg" alt="" width="519" height="446"/>
            </div>
            <div class="col-md-10 col-lg-7 col-xl-6">
              ...
              <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-4">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item" role="presentation"><a class="nav-link " href="#tabs-4-1" data-toggle="tab">Limpeza e Higiene</a></li>
                ...
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="tabs-4-1">
                    ...
                    <div class="group-md group-middle"><a class="button button-width-xl-230 button-primary button-pipaluk" href="#">Veja Mais</a><a class="button button-width-xl-310 button-default-outline button-wapasha" href="contatos.php">Contate-nós</a></div>
                  </div>
      ...
      <section class="section context-dark">
        <div class="parallax-container" data-parallax-img="images/banner/07.jpg">
          <div class="parallax-content section-md bg-overlay-2-21">
            <div class="container">
              <div class="oh">
                <h2 class="wow slideInUp" data-wow-delay="0s">Comentarios de nossos clientes</h2>
              </div>
              <!-- Owl Carousel-->
              <div class="owl-carousel owl-modern" data-items="1" data-stage-padding="15" data-margin="30" data-dots="true" data-animation-in="fadeIn" data-animation-out="fadeOut" data-autoplay="true">
                <!-- Quote Lisa-->
                <article class="quote-lisa">
                  <div class="quote-lisa-body"><a class="quote-lisa-figure" href="#"><img class="img-circles" src="images/usuarios/user-01.jpg" alt="" width="100" height="100"/></a>
                    <div class="quote-lisa-text">
                      <p class="q">O café daqui é incrível! Dá pra sentir que é feito com grãos de qualidade, e o ambiente é perfeito pra relaxar depois de um dia cheio. Com certeza vou virar cliente fiel!</p>
                    </div>
                    <h5 class="quote-lisa-cite"><a href="#">Arthur Queiroz</a></h5>
                    <p class="quote-lisa-status">Regular Client</p>
                  </div>
                </article>
                <!-- Quote Lisa-->
                <article class="quote-lisa">
                  <div class="quote-lisa-body"><a class="quote-lisa-figure" href="#"><img class="img-circles" src="images/usuarios/user-02.jpg" alt="" width="100" height="100"/></a>
                    <div class="quote-lisa-text">
                      <p class="q">Simplesmente amei! O latte de caramelo é delicioso e a atmosfera é tão aconchegante. Dá vontade de ficar horas aqui. Definitivamente, meu novo café favorito na cidade!</p>
                    </div>
                    <h5 class="quote-lisa-cite"><a href="#">Amanda souza</a></h5>
                    <p class="quote-lisa-status">Regular Client</p>
                  </div>
                </article>
                <!-- Quote Lisa-->
                <article class="quote-lisa">
                  <div class="quote-lisa-body"><a class="quote-lisa-figure" href="#"><img class="img-circles" src="images/usuarios/user-03.jpg" alt="" width="100" height="100"/></a>
                    <div class="quote-lisa-text">
                      <p class="q">Eu sempre passo aqui antes de ir pro trabalho, e nunca decepcionam. O expresso é forte, do jeito que gosto, e a equipe é super atenciosa. Vale cada centavo.</p>
                    </div>
                    <h5 class="quote-lisa-cite"><a href="#">Magno de Almeida</a></h5>
                    <p class="quote-lisa-status">Regular Client</p>
                  </div>
                </article>
              </div>
