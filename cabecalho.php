...
<head>
  ...
  <meta name="description" content="Vendas de bebidas quentes, frias e acompanhamentos ">
  <meta name="author" content="Valwanderson de A. Xavier">
...
<body>
  ...
  <div class="page">
          ...
          <div class="rd-navbar-main-outer">
            <div class="rd-navbar-main">
              ...
              <div class="rd-navbar-panel">
                ...
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand"><a title="Ir para Página Inicial" class="brand" href="index.php"><img src="images/logo-default-195x62.png" alt="" width="196" height="47" /></a></div>
              </div>
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <?php if (!isset($_SESSION['nome_usuario'])) {
                      ...
                      if ($_SESSION['nivel_usuario'] == 'Cliente') {
                        echo '<li class="rd-nav-item"><a class="rd-nav-link" href="painel-cliente">Painel</a>
                            </li>';
                      }
              ...
              <div class="rd-navbar-project rd-navbar-modern-project">
                ...
                <div class="rd-navbar-project-content rd-navbar-modern-project-content">
                  <div>
                    <p>Siga-nos em nossas redes sociais e fique por dentro das promoções!</p>
                    ...
                    <ul class="rd-navbar-modern-contacts">
                      <li>
                        <div class="unit unit-spacing-sm">
                          ...
                          <div class="unit-body"><a target="_blank" title="Ir para o Whatsapp" class="link-phone" href="http://api.whatsapp.com/send?1=pt_BR&phone=5594984000000">(94)98400-0000</a></div>
                        </div>
                      </li>
                      <li>
                        <div class="unit unit-spacing-sm">
                          <div class="unit-left"><span class="icon fa fa-location-arrow"></span></div>
                          <div class="unit-body"><a class="link-location" href="contatos">Rua da torre
                        ...
                        <div class="unit unit-spacing-sm">
                          ...
                          <div class="unit-body"><a class="link-location" href="#">Entregamos em toda a cidade, taxa unica de R$ 5,00</a>
                        </div>
                      ...
                      <li>
                        <div class="unit unit-spacing-sm">
                          ...
                          <div class="unit-body"><a class="link-email" href="mailto:#">adm@gmail.com</a></div>
                        </div>
                      </li>
                    </ul>
                    <ul class="list-inline rd-navbar-modern-list-social">
                      <li><a title="Ir para página no facebook" class="icon fa fa-facebook" href="https://www.facebook.com/"></a></li>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control form-control-sm" id="" name="bairro" required>
                      ...
                      $res = $pdo->query("SELECT * from locais");
                      $dados = $res->fetchAll(PDO::FETCH_ASSOC);
    ...
    <script> $("#modal-dados").modal("show"); </script> 
